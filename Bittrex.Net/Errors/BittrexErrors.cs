    ...
    internal static class BittrexErrors
    {
        internal static Dictionary<BittrexErrorKey, BittrexError> ErrorRegistrations =
            new Dictionary<BittrexErrorKey, BittrexError>()
            {
                ...
                { BittrexErrorKey.ErrorWeb, new BittrexError(7002, "Server returned a not successful status")},
                { BittrexErrorKey.CantConnectToServer, new BittrexError(7003, "Could not connect to Bittrex server")},
